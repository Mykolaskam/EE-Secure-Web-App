...
class SessionModel
{
  ...
  {
      $m_session_details['user_name'] = $this->c_obj_wrapper_session_file->get_session('user_name');
      $m_session_details['password'] = $this->c_obj_wrapper_session_file->get_session('password');

      return $m_session_details;
